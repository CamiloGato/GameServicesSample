...
namespace PlayerMovement
{
    ...
    public class TopDownWasdController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            zoomAction = inputActions.FindAction("CameraZoom");
            dragAction = inputActions.FindAction("CameraDrag");
        ...
        private void LateCameraUpdate()
        {
            if (isDraggable)
            {
                ...
                else if (dragAction.phase == InputActionPhase.Performed)
                {
                    Vector3 point = GetPoint();
            ...
            if (dragAction.phase == InputActionPhase.Canceled)
            {
                _isDragging = false;
            }
